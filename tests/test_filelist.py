...
class TestMergedbranch(unittest.TestCase):
  ...
  def test_sort_by(self):
    ...
    expect = [
        ...
        'change-940.yml', 'test_CHANGELOG.md', 'template.yml', 'minichange.md',\
        'this_file_should_be_excluded.txt', 'conftest.conf', 'logscribe.conf', \
        'gitlog.txt', 'change-939-mr749.yml'
    ]
